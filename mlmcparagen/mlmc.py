...
class MLMC_Solver:
    ...
    def __init__(self, problem, levels, repetitions, comm=None, comm_limits=None):
        """
        :arg problem: MLMC_Solver object containing problem.
        :arg levels: number of levels in MLMC
        :arg repetitions: list of repetitions at each level starting at coarsest
        """
    ...
    def solve(self):
        ...
        for i in range(self.levels):
            ...
            # Create P_level obj in soln list
            self.MLMCproblem.newLevel(i)
            ...
            for j in range(self._new_reps[i]):
                ...
                # Calculate result from sample
                self.MLMCproblem.addTerm(i)
...
class MLMC_Problem:
    def __init__(self, problem_class, sampler, lvl_maker):
        """
        :arg problem_class: class initialised with one argument - one of
        ...
        :arg sampler: two argument function which takes the two
        ...
        :arg lvl_maker: two argument function which takes two integer
